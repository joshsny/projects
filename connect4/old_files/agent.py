...
# Define the ConvBlock class for the CNN
class ConvBlock(nn.Module):
    ...
    def forward(self, s):
        s = s.view(-1,3,6,7) # flatten
        s = F.relu(self.bn1(self.conv1(s)))
        return s

# Define the ResBlock class for the CNN
...
# Define the OutBlock class for the CNN
...
# Put together the blocks to form the network
